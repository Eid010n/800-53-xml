...
<xsl:stylesheet
    ...
    <xsl:template name="control-info">
        ...
        <xsl:text>&#x9;</xsl:text>
        <xsl:value-of select="c:baseline-impact"/>
        <xsl:text>&#x9;</xsl:text>
        ...
        <xsl:if test="c:supplemental-guidance/c:description">
            <xsl:text>"</xsl:text><xsl:value-of select="c:supplemental-guidance/c:description"/><xsl:text>"</xsl:text>
        </xsl:if>
        <xsl:text>&#x9;</xsl:text>
        <xsl:value-of select="c:supplemental-guidance/c:related"/>
    </xsl:template>
